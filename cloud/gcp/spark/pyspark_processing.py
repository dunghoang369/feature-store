...
if __name__ == "__main__":
    ...
    parquet_files = glob("diabetes-deltalake/**/*.parquet", recursive=True)
    print(parquet_files)
    ...
    for i, parquet_file in enumerate(parquet_files):
        ...
        df.select(
            ...
            "Pregnancies_normed",
            "BloodPressure_normed",
            "SkinThickness_normed",
            "Insulin_normed",
            "Age_normed",
            ...
            "url", "jdbc:postgresql://35.202.131.184:5432/k6"
        ).option(
            "dbtable", "diabetes_test"
        ).save()
